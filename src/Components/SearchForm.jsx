...
const SearchForm = ({
  ...
  const guestCount = adult + child + infant + pet;
            ...
            {guestCount
              ? !(infant || pet)
                ...
                : !pet ?
                        ...
                        : (infant && pet) ?
                            `게스트 ${+adult + +child}명, 유아 ${infant}명, 펫 ${pet}마리`
                            :`게스트 ${+adult + +child}명, 반려동물 ${pet}마리`
              : '게스트 추가'}
          </StContentText>
        </StTextWrapper>
        <StResetBtn
            ...
            onClick={() => {
              changeSearchData('guests', { adult: 0, child: 0, infant: 0, pet: 0 });
            }}
        >
          <MdClose />
        </StResetBtn>
